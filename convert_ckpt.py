...
ckpt_path = './ckpt/fasterrcnn_resnet50_fpn_coco-258fb6c6.pth'
device = 'cuda:3'
...
model = fasterrcnn_resnet50_fpn(num_classes=91, box_score_thresh=0.05, box_nms_thresh=0.99, box_detections_per_img=1000)
model = model.to(device=device)
model.load_state_dict(torch.load(ckpt_path,map_location=device))
torch.save(model,"./ckpt/FasterRCNN-Official-COCO.pt")